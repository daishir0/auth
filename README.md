...
または、管理画面から登録：`https://auth.senku.work/admin/oauth/clients`
...
```env
AUTH_SENKU_ISSUER=https://auth.senku.work
AUTH_SENKU_ID=your-client-id
AUTH_SENKU_SECRET=your-client-secret
```
